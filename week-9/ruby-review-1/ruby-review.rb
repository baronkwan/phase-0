...
# I worked on this challenge [Baron Kwan, Lydia Nash].
...
# The very important concept --- Inheritance. And also the ability to get the driver code working.


# What is still confusing to you about Ruby?

# Sometime I felt a bit confused about the syntax and its usage because of jumping back and forth between
# different languages. Need more practice to solidify and make the transition smoothier.


# What are you going to study to get more prepared for Phase 1?

# As mentioned above, practice more on different languages so that I can get used to jumping back and forth
# between languages.
